...
async def list_scenarios(session: AsyncSession = Depends(get_db_session)) -> list[PlanScenarioRead]:
...
async def generate_plan(
    payload: PlanGenerationRequest, session: AsyncSession = Depends(get_db_session)
